      ...
      <div class="wrapper">
        ...
        <nav>
          <ul id="menu">
            ...
            <li id="menu_active"><a href="projects.php">Projects</a></li>
        ...
        <div class="box2">
          <div class="wrapper tab-content" id="2017">
            <section class="col1">
                ...
                <h4><span>January </span> 2017</h4>
                <p class="pad_bot2"><strong>Collaboration with 'Bachon Ka Ghar'</strong></p>
                <p class="pad_bot1">Looking at the grave situation of their current location, we decide to permanently finance the rent of a well
                                    furnished house in Pakistan Town, for the 35 orphans, all below age 10, residing there.</p>

                <h4><span>March 8</span> 2017</h4>
                <p class="pad_bot2"><strong>New initiative with 'Sha'or Society'</strong></p>
                <p class="pad_bot1">Every sunday, Daighs are distributed to a backward community in the rural regions of Rawalpindi.</p>

                <h4><span>March 30</span> 2017</h4>
                <p class="pad_bot2"><strong>Our coverage of complete educational expenses for children continues</strong></p>
                <p class="pad_bot1">For more than a year and continuing, we are constantly supporting 5 bright students
                                    continuing their studies in prestigious institutions i.e 'Allied School'</p>

                <h4><span>June 25</span> 2017</h4>
                <p class="pad_bot2"><strong>Another year, another massive arrangement of Iftar Dastarkhuwa'n throughout entire Ramadan</strong></p>
                <p class="pad_bot1">Due to our constant work during the Holy month for 4 years straight, this year leads to
                                    ever so increasing crowd at 22 Number Chungi, Rawalpindi</p>
          </div>
          ...
          <div class="wrapper tab-content" id="2016">
            <section class="col1">
                ...
                <h4><span>December 7</span> 2016</h4>
                <p class="pad_bot2"><strong>Donations issued to an individual for travelling abroad to support his family</strong></p>
                <p class="pad_bot1">Rovaif Babar's parents both suffered from illnesses. In order to support his mother and sister's
                    education, he found a job abroad, and his travelling costs were covered.</p>

                <h4><span>December 10</span> 2016</h4>
                <p class="pad_bot2"><strong>Donations issued to female for kickstarting her business</strong></p>
                <p class="pad_bot1">Abandoned by her family after her father's death and her husband fleeing with along
                                    her belongings, a single mother is helped in starting her own painting and
                                    crafts business to support herself and her daughter.</p>
